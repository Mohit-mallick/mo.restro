...
document.querySelector("#MOHIT-MALLICK").addEventListener("mousemove", function () {
  document.querySelector("#slider-upar-wala").style.marginTop = "0%";
  document.querySelector("#MOHIT-MALLICK").style.cursor = "pointer";
});
document.querySelector("#MOIN-LATIEF").addEventListener("mousemove", function () {
  document.querySelector("#slider-upar-wala").style.marginTop = "-50vh";
  document.querySelector("#MOIN-LATIEF").style.cursor = "pointer";
});
document.querySelector("#SAJID-KHAN").addEventListener("mousemove", function () {
  document.querySelector("#slider-upar-wala").style.marginTop = "-100vh";
  document.querySelector("#SAJID-KHAN").style.cursor = "pointer";
});
document.querySelector("#MOHIT-DHIMAN").addEventListener("mousemove", function () {
  document.querySelector("#slider-upar-wala").style.marginTop = "-150vh";
  document.querySelector("#MOHIT-DHIMAN").style.cursor = "pointer";
});
